...
TRANSLATIONS = {
    'ru': {
        ...
        'surveys':'Анкеты качества','resources':'Бронирование ресурсов','kpi':'KPI / Рейтинг','labor':'Трудозатраты',
    ...
    'kk': {
        ...
        'surveys':'Сапа сауалнамалары','resources':'Ресурстарды брондау','kpi':'KPI / Рейтинг','labor':'Еңбек шығындары',
    ...
    'en': {
        ...
        'surveys':'Quality surveys','resources':'Resource booking','kpi':'KPI / Rating','labor':'Labor analytics',
