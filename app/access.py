...
ROLE_PERMISSIONS: dict[str, set[str]] = {
    ...
    ROLE_TECHNICIAN: {
        ...
        "ticket.time.track", "ticket.time.manual_self", "ticket.stock.issue",
    ...
    ROLE_DISPATCHER: {
        ...
        "ticket.contractor", "ticket.stock.issue",
    ...
    ROLE_MANAGER: {
        ...
        "ticket.list_all", "ticket.list", "ticket.create", "ticket.comment",
        "ticket.assign", "ticket.dispatch_status", "ticket.set_priority",
        "ticket.contractor", "ticket.cost", "ticket.close", "ticket.cancel",
